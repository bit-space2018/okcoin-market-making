...
COIN_FEE = '/api/account/v3/withdrawals/fee'
COINS_WITHDRAW_RECORD = '/api/account/v3/withdrawals/history'
COIN_WITHDRAW_RECORD = '/api/account/v3/withdrawals/history/'
...
SPOT_REVOKE_ORDERS = '/api/spot/v3/orders'
...
LEVER_REVOKE_ORDERS = '/api/margin/v3/orders'
...
FUTURE_PRODUCTS_INFO = '/api/futures/v3/products'
FUTURE_DEPTH = '/api/futures/v3/products/'
FUTURE_TICKER = '/api/futures/v3/products/ticker'
FUTURE_SPECIFIC_TICKER = '/api/futures/v3/products/'
FUTURE_TRADES = '/api/futures/v3/products/'
FUTURE_KLINE = '/api/futures/v3/products/'
FUTURE_INDEX = '/index'
FUTURE_RATE = '/rate'
FUTURE_ESTIMAT_PRICE = '/api/futures/v3/products/estimated_price'
FUTURE_HOLDS = ' /api/futures/v3/products/'
FUTURE_LIMIT = '/api/futures/v3/products/'
FUTURE_LIQUIDATION = '/api/futures/v3/products/'
